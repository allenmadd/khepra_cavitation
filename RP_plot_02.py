...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 24 20:41:15 2019
...
b2=unpickle_thing('pickled_bubble_1.xml')
b3=unpickle_thing('pickled_bubble_2.xml')
...
#plt.tight_layout()
#plt.show()
plt.savefig('RPeq_CornOil_around_rmin.png',dpi=240,bbox_inches='tight') # see here: http://stackoverflow.com/questions/21288062/second-y-axis-label-getting-cut-off
plt.close()
